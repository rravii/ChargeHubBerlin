...
from community.domain.value_objects import UserId, StationId, StarRating
from community.infrastructure.repositories import InMemoryRatingRepository
from community.infrastructure.EventBus import InMemoryEventBus
from community.application.services import RatingService
