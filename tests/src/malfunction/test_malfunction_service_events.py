"""Integration tests for malfunction reporting flow and emitted events."""
...
from src.malfunction.infrastructure.repositories import (
    InMemoryIncidentRepository,
)
from src.infrastructure.EventBus import InMemoryEventBus
from src.malfunction.application.services import MalfunctionService
from src.malfunction.domain.events import (
